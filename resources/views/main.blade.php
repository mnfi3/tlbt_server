...
<div class="hero-wrap js-fullheight">
  ...
  <div class="container">
{{--    <div class="robot-pic js-tilt" data-tilt>--}}
{{--      <img class="img-robot" src="{{asset('images/img_robot.png')}}" alt="IMG" />--}}
{{--    </div>--}}
    <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
      <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
        ...
        <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#" class="btn btn-primary btn-outline-white px-5 py-3">رایگان تست کنید</a></p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="container-fluid" data-scrollax-parent="true">
      ...
      <div class="row mt-5 d-flex justify-content-center">
        <div class="col-md-8 text-center heading-section ftco-animate ">
          ...
          <p class="see-demo-cn  mt-5" ><a href="#" class="see-demo pulse animated mt-5 py-3 px-5">مشاهده ویدیو دمو</a></p>
        </div>
      </div>
    </div>
