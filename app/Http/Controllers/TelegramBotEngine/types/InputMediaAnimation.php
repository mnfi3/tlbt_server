...
public $type	; //String	Type of the result, must be animation
...
public $caption	; //String	Optional. Caption of the animation to be sent, 0-1024 characters after entities parsing
...
public $width	; //Integer	Optional. Animation width
public $height	; //Integer	Optional. Animation height
public $duration	; //Integer	Optional. Animation duration
