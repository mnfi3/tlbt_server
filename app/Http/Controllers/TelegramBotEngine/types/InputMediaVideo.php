...
public $width	; //Integer	Optional. Video width
public $height	; //Integer	Optional. Video height
public $duration	; //Integer	Optional. Video duration
public $supports_streaming	; //Boolean	Optional. Pass True, if the uploaded video is suitable for streaming
